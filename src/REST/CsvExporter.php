...
class CsvExporter {
	...
	public function export( QueryBuilder $query_builder, InstancesRepository $instances_repo, array $args ): string {
		...
		fputcsv(
			$csv,
			array(
				__( 'ID', 'smart-link-checker' ),
				__( 'URL', 'smart-link-checker' ),
				__( 'Final URL', 'smart-link-checker' ),
				__( 'HTTP Status', 'smart-link-checker' ),
				__( 'Status', 'smart-link-checker' ),
				__( 'Type', 'smart-link-checker' ),
				__( 'Affiliate', 'smart-link-checker' ),
				__( 'Network', 'smart-link-checker' ),
				__( 'Cloaked', 'smart-link-checker' ),
				__( 'Redirect Count', 'smart-link-checker' ),
				__( 'Response Time (ms)', 'smart-link-checker' ),
				__( 'Instances', 'smart-link-checker' ),
				__( 'Last Checked', 'smart-link-checker' ),
				__( 'Last Error', 'smart-link-checker' ),
			)
		);
			...
			foreach ( $items as $link ) {
				...
				fputcsv(
					...
					array(
						...
						$link->is_external ? __( 'external', 'smart-link-checker' ) : __( 'internal', 'smart-link-checker' ),
						$link->is_affiliate ? __( 'yes', 'smart-link-checker' ) : __( 'no', 'smart-link-checker' ),
						$this->sanitize_csv_value( $link->affiliate_network ?? '' ),
						$is_cloaked ? __( 'yes', 'smart-link-checker' ) : __( 'no', 'smart-link-checker' ),
						$link->redirect_count,
						$link->response_time ?? '',
